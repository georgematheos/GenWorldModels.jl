...
@inline function get_abstract(table::IDTable, concrete::ConcreteIndexOUPMObject{T, OriginType}) where
        {T, OriginType <: Tuple{Vararg{<:AbstractOUPMObject}}}
...
FunctionalCollections.assoc(::IDTable, ::AbstractOUPMObject{T}, c::ConcreteOUPMObject{T}) where {T} = concrete_origin_error(c)
...
"""
function generate_abstract_for(table::IDTable, concrete::ConcreteIndexOUPMObject{T, OT}) where
        {T, OT <: Tuple{Vararg{<:AbstractOUPMObject}}}
    id = gensym()
